...
namespace Raven.Client.Connection
{
	...
	public interface IDatabaseCommands : IHoldProfilingInformation
	{
		...
		void Patch(string key, PatchRequest[] patches, bool ignoreMissing);
		...
		/// <param name="patch">The patch request to use (using JavaScript)</param>
		/// <param name="ignoreMissing">true if the patch request should ignore a missing document, false to throw DocumentDoesNotExistException</param>
		void Patch(string key, ScriptedPatchRequest patch, bool ignoreMissing);
		...
		void Patch(string key, PatchRequest[] patchesToExisting, PatchRequest[] patchesToDefault, RavenJObject defaultMetadata);
		...
		/// <param name="defaultMetadata">The metadata for the default document when the document is missing</param>
		void Patch(string key, ScriptedPatchRequest patchExisting, ScriptedPatchRequest patchDefault, RavenJObject defaultMetadata);
